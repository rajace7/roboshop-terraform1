...
#  source = "git::https://github.com/rajace7/tf-module-app.git"
#
# for_each         = var.app
...
module "docdb" {
  source = "git::https://github.com/rajace7/tf-module-docdb.git"
...
module "rds" {
  source = "git::https://github.com/rajace7/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/rajace7/tf-module-elasticache.git"
